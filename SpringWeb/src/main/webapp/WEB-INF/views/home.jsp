...
<div class="container" style="margin-top:30px">
  <div class="row">
    <div class="col-sm-5">
      ...
      <div>
      	<!-- 사진을 넣어보실래요????????경로는 절대경로! -->
      	<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/test.svg" height="300px" width="500px">
      </div>
      <p>한지민</p>
      <h3>소셜 링크</h3>
    ...
    <div class="col-sm-6">
     ...
     <div style="height: 400px;">
      ...
      <h2>나의 일상</h2>
      <h5>여행, Sep 2, 2017</h5>
      <div><img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/member2.jpg" height="600" width="600"></div>
      <p>한지민</p>
      <p>내용을 작성하세요</p>
    </div>
  </div>
